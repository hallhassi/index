...
cat <<EOF
<html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="scrub.css"><style>body{white-space:pre;background:red;margin:1.2em 0 calc(100vh - 2em) 0;line-height:1.2em;}a{all:unset;cursor:pointer;}</style></head><body>
<div>
...
echo '</div><div id="wrapper"><canvas id="tv" width="0" height="0"></canvas></div><div id="stickywrapper"><a id="sticky"></a></div><script src="scrub.js"></script></body></html>'
